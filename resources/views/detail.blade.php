        ...
        <div class="container py-5">
            <div class="row">
                       ...
                       @foreach ($myarr as $item)
                            <a class="courses-list-item position-relative d-block overflow-hidden mb-2"
                             href="{{route('course.details',['id'=>$item->id])}}">
                                <img class="img-fluid" src="{{$item->getFirstMediaUrl('thumbnail','card')}}" 
                                alt="{{$item->getFirstMedia('thumbnail')->name}}">
                                <div class="courses-text">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                        ...
                        <ul class="list-group list-group-flush">
                            @foreach ($tags as $tag)
                                <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                    <a href="" class="text-decoration-none h6 m-0">{{$tag->title}}</a>
                                    <span class="badge badge-primary badge-pill">{{count($tag->courses)+count($tag->blogs)}}</span>
                                </li>
                            @endforeach
                        </ul>
                    </div>
                    ...
                    <div class="mb-5">
                        <h2 class="mb-4">Recent Content</h2>
