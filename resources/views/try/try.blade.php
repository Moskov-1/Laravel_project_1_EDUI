            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                ...
                @auth
                    ...
                    <form action="{{ url('/logout') }}"
                        method="POST">
                        @csrf
                        <x-dash-log-out :href="route('logout')"
                    ...
                    @else
                    <a href="{{ url('/dashboard') }}" class="btn btn-primary py-2 px-4 d-none d-lg-block">Dashboard</a>
                    <form action="{{ url('/logout') }}"
                        method="POST">
                        @csrf
                        <x-dash-log-out :href="route('logout')"
                            ...
                            <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute w-100 h-100"
                                        src="{{$blog->getFirstMediaUrl('thumbnail')}}" 
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-5" style="min-height: 500px;">
                                <div class="position-relative h-100">
                                    <img class="position-absolute w-100 h-100" 
                                        src="{{$blog->getFirstMediaUrl('thumbnail')}}" style="object-fit: cover;">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{Vite::asset('resources/img/about.jpg')}}" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="section-title position-relative mb-4">
    ...
    <div class="container-fluid bg-image" style="margin: 90px 0;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="{{Vite::asset('resources/img/feature.jpg')}}" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{Vite::asset('resources/img/team-1.jpg')}}" alt="">
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{Vite::asset('resources/img/team-2.jpg')}}" alt="">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Instructor Name</h5>
                        <p class="mb-2">Web Design & Development</p>
                        <div class="d-flex justify-content-center">
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{Vite::asset('resources/img/team-3.jpg')}}" alt="">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Instructor Name</h5>
                        <p class="mb-2">Web Design & Development</p>
                        <div class="d-flex justify-content-center">
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="{{Vite::asset('resources/img/team-4.jpg')}}" alt="">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Instructor Name</h5>
                        <p class="mb-2">Web Design & Development</p>
                        <div class="d-flex justify-content-center">
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="bg-white p-5">
                            ...
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{Vite::asset('resources/img/testimonial-2.jpg')}}" alt="">
                                <div>
                                    <h5>Student Name</h5>
                        ...
                        <div class="bg-white p-5">
                            ...
                            <p>Sed et elitr ipsum labore dolor diam, ipsum duo vero sed sit est est ipsum eos clita est ipsum. Est nonumy tempor at kasd. Sed at dolor duo ut dolor, et justo erat dolor magna sed stet amet elitr duo lorem</p>
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="{{Vite::asset('resources/img/testimonial-1.jpg')}}" alt="">
                                <div>
                                    <h5>Student Name</h5>
                                    <span>Web Design</span>
                                </div>
